...
# Hugh Sierra Style Dark MenuBar
...
# Finder: add path navigation to Finder toolbar
# -- position prior to action button (target index=4 based on default toolbar)
/usr/libexec/PlistBuddy -c "Add :NSToolbar\ Configuration\ Browser:TB\ Item\ Identifiers:4 string com.apple.finder.PATH" $HOME/Library/Preferences/com.apple.finder.plist
...
# pen and save files as UTF-8 in TextEdit
